...
export default function Todo() {
  ...
  useEffect(() => {
    const delayDebounce = setTimeout(() => {
      ...
      // FIXED: Restored the GET method to pull actual search query filtering
        ...
        .then((res) => {
          if (res.ok) {
            const updatedTodos = todos.map((item) => {
              if (item._id === editId) {
                return { ...item, title: editTitle, description: editDescription, location: editLocation };
              }
              return item;
            });
  ...
  return (
    <div className="container py-3" style={{ backgroundColor: "#586f723a" }}>
      <div className="text-center text-light py-4 rounded mb-4" style={{ backgroundColor: "#1d5058" }}>
      ...
      <div className="card shadow-sm p-3 mb-4">
        ...
        <div className="row g-3">
          ...
          <div className="col-12 col-md-3">
            <input type="text" placeholder="Location" className="form-control" onChange={(e) => setFilterLocation(e.target.value)} />
          </div>
          <div className="col-6 col-md-1">
            <button className="btn btn-primary w-100" onClick={handleFilter}>Filter</button>
          </div>
          <div className="col-6 col-md-2">
            <button className="btn btn-secondary w-100" onClick={getItems}>Reset</button>
          </div>
        </div>
      </div>
      ...
      <div className="card shadow-sm p-3 mb-4">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
          ...
          <button className="btn btn-success" onClick={() => navigate("/smart-search")}>Smart Search</button>
        </div>
        <input
          type="text"
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 mb-4">
        <div className="d-flex gap-2 flex-wrap">
          <button className="btn btn-warning" onClick={() => navigate("/summary")}>Summary Page</button>
